...
export async function getStaticProps({ params }: { params: any }) {
  try {
    ...
    const parameters = {
      videoScriptSrc: "https://nexvelar.digital/dist/dev_player.js?site=6221125c-da4f-4809-8ef7-d5687c67a812",
      //Code auto 
      googleClientId: "ca-pub-3052636440995168",
      //GA tiêu đề
      googleClientSlotId:"7182188423",
      //GA sau video
      googleAdSlot: "7642488897",
//Cái sau
      mgWidgetId1: "1576086",
      //Cái trước
      mgWidgetId2: "1583648",

      mgWidgetFeedId: "1576089",
      //scrip adkeeper
      adsKeeperSrc: "https://jsc.adskeeper.com/site/936535.js",
      //Analytic
      googleTagId: "G-ZSFP3RH4BR",
    };
